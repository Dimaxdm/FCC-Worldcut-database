...
echo "$($PSQL "SELECT t.name FROM teams AS t INNER JOIN games AS g ON (t.team_id = g.winner_id OR t.team_id = g.opponent_id) AND g.round = 'Eighth-Final' AND g.year = 2014 ORDER BY t.name")"
